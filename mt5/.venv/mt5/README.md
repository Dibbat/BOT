...
Demo live launcher with MT5 auth retry and demo-server safety check:
...
One-cycle test mode (demo launcher):

python mt5/pt_mt5_demo_live.py --config mt5/mt5_config.json --once
